...
execute: 
  echo: false
  warning: false
title: "Relatorio Final - Corrigido 1"
...
tab_descritiva_INC <- df_incidencia_A |> 
  ...
  summarise(Mean = round(mean(Incidencia_percent), 2), 
            SD = round(sd(Incidencia_percent), 2)) |> 
  arrange(Dias, Taxa)
# tab_descritiva_INC
```
...
```{r}
#| label: Incidência-tabela-descritiva-geral
## Tabela descritiva
tab_descritiva_INC_geral <- df_incidencia_A |> 
  group_by(Tratamento, Adjuvante, Taxa)%>% 
  summarise(Mean = round(mean(Incidencia_percent), 2), 
            SD = round(sd(Incidencia_percent), 2)) |>
  arrange(Taxa)

as.data.frame(tab_descritiva_INC_geral[]) |> 
  gt() %>%
  cols_label(
    ...
    Mean = md("**Média (%)**"),
    SD = md("**Desvio**")) %>%
  tab_header(title = md("***Incidência - Geral***"),
             subtitle = md("**Porcentagem de plantas atacadas**")) %>%
  tab_options(
...
```{r}
#| label: Incidência-tabela-descritiva-0DAA
## Tabela descritiva
as.data.frame(tab_descritiva_INC[]) |> 
  ...
  cols_label(
    ...
    Mean = md("**Média (%)**"),
    SD = md("**Desvio**")) %>%
  tab_header(title = md("***Incidência - 0DAA***"),
             subtitle = md("**Porcentagem de plantas atacadas**")) %>%
  tab_options(
    table.width = pct(95)  # Define a largura da tabela como 100% da área disponível
  )
...
```{r}
#| label: Incidência-tabela-descritiva-3DAA
## Tabela descritiva
as.data.frame(tab_descritiva_INC[]) |> 
  filter(Dias == "3DAA") |> 
  select(!Dias) |> 
  ...
  cols_label(
    ...
    Mean = md("**Média (%)**"),
    SD = md("**Desvio**")) %>%
  tab_header(title = md("***Incidência - 3DAA***"),
             subtitle = md("**Porcentagem de plantas atacadas**")) %>%
  tab_options(
    table.width = pct(95)  # Define a largura da tabela como 100% da área disponível
  )
...
```{r}
#| label: Incidência-tabela-descritiva-7DAA
## Tabela descritiva
as.data.frame(tab_descritiva_INC[]) |> 
  filter(Dias == "7DAA") |> 
  select(!Dias) |> 
  ...
  cols_label(
    ...
    Mean = md("**Média (%)**"),
    SD = md("**Desvio**")) %>%
  tab_header(title = md("***Incidência - 7DAA***"),
             subtitle = md("**Porcentagem de plantas atacadas**")) %>%
  tab_options(
    table.width = pct(95)  # Define a largura da tabela como 100% da área disponível
  )
...
```{r}
#| label: Incidência-tabela-descritiva-3DAB
## Tabela descritiva
as.data.frame(tab_descritiva_INC[]) |> 
  filter(Dias == "3DAB") |> 
  select(!Dias) |> 
  ...
  cols_label(
    ...
    Mean = md("**Média (%)**"),
    SD = md("**Desvio**")) %>%
  tab_header(title = md("***Incidência - 3DAB***"),
             subtitle = md("**Porcentagem de plantas atacadas**")) %>%
  tab_options(
    table.width = pct(95)  # Define a largura da tabela como 100% da área disponível
  )
...
```{r}
#| label: Incidência-tabela-descritiva-7DAB
## Tabela descritiva
as.data.frame(tab_descritiva_INC[]) |> 
  filter(Dias == "7DAB") |> 
  select(!Dias) |> 
  ...
  cols_label(
    ...
    Mean = md("**Média (%)**"),
    SD = md("**Desvio**")) %>%
  tab_header(title = md("***Incidência - 7DAB***"),
             subtitle = md("**Porcentagem de plantas atacadas**")) %>%
  tab_options(
    table.width = pct(95)  # Define a largura da tabela como 100% da área disponível
  )
...
as.data.frame(tab_descritiva_INC[]) |> 
  ...
  cols_label(
    ...
    Mean = md("**Média**"),
    SD = md("**Desvio**")) %>%
  tab_header(title = md("***Severidade***")) %>%
  tab_options(
    table.width = pct(95)  # Define a largura da tabela como 100% da área disponível
  )
